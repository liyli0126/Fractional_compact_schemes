function [x_opt, A, b, L2_error] = solve_redu_inter_bdy_frequency_i3_h(gamma, h, x_points_inter, plot_flag)
% Input:
...
%  L2_error: L^2 error of the approximation (optional)
   ...
   % Define alpha
    ...
    if plot_flag
        ...
        title(sprintf('Relative Error  (\\gamma=%.2f, N=%d, j=i_3)', gamma, 1/h), 'FontSize', 12);
        grid on;
