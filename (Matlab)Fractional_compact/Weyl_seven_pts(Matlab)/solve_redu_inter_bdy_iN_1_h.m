function [x_opt, A, b, L2_error] = solve_redu_inter_bdy_iN_1_h(gamma, h, x_points_inter, plot_flag)
% Input:
...
%  L2_error: L^2 error of the approximation (optional)
    ...
    if plot_flag
        ...
        % Print L^2 error
        fprintf('Boundary iN_1 scheme: L^2 error = %.6e (gamma=%.2f, h=%.6e)\n', L2_error, gamma, h);
        ...
        title(sprintf('L^2 Error - iN_1: \\gamma=%.2f, h=%.6e, L^2=%.4e, Range=[0, %.2f]', ...
